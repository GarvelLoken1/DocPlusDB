...
"DocPlusDB" - это программное обеспечение с пользовательским интерфесом включающим в себя базу данных медицинского оборудования и журналом ремонтов. Имеет фильтры поиска по адресам/типу/наименованию, возможность добавления и редактирования оборудования в пару кликов, просмотр информации о нем и журнал ремонтов. Имеет две версии: пользовательскую и сервисную.

<details><summary><b>Инструкция</b></summary>

Программа состоит из двух вкладок:
1. Вкладка "Оборудование" предоставляет информацию об оборудовании с возможностью редактирования и добавления. Состоит из двух блоков
   1.1. Блок Поиска (Верхний)
   1.2. Блок Добавлений (Нижний)
2. Вкладка "Журнал" предоставляет информацию о работах произведенных с оборудованием
